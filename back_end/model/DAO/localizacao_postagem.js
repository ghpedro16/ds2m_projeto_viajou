...
const getSelectLocationByIdPost = async function(id_postagem){
    try {
        let sql = `SELECT tbl_localizacao.id, tbl_localizacao.pais 
                FROM tbl_postagem inner join tbl_localizacao_postagem
                ON tbl_postagem.id = tbl_localizacao_postagem.id_postagem
...
const getSelectLastId = async function(){
    try{
        ...
        let sql = `select id from tbl_localizacao_postagem order by id desc limit 1`
